// Shadcn Toast hook — module-scoped singleton queue + React state bridge.
// Components call `toast({...})` imperatively; `useToast()` subscribes to the
// queue so <Toaster /> can render it.
